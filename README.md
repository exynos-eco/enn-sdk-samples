...
#### Location
The sample is available in the `enn-sdk-samples/image-classification` directory within the [Github](https://github.com/exynos-eco/enn-sdk-samples) repository.
...
5.  Run the image classification project from the sample applications obtained through git clone in Android Studio.
...
#### Location
The sample is available in the `enn-sdk-samples/object-detection` directory within the [Github](https://github.com/exynos-eco/enn-sdk-samples) repository.
...
#### Location
The sample is available in the `enn-sdk-samples/semantic-segmentation` directory within the [Github](https://github.com/exynos-eco/enn-sdk-samples) repository.
...
#### Location
The sample is available in the `enn-sdk-samples/pose-estimation` directory within the [Github](https://github.com/exynos-eco/enn-sdk-samples) repository.
...
#### Location
The sample is available in the `enn-sdk-samples/image-enhancement` directory within the [Github](https://github.com/exynos-eco/enn-sdk-samples) repository.
...
3.  Use adb push command to push a sample image to the following path for testing.
4.  Select Tools → Device Manager in Android Studio. Please verify whether the physical device is properly connected.
5.  Run the image enhancement project from the sample applications obtained through git clone in Android Studio.
6.  Upload the image data for inference and execute the application.
...
#### Location
The sample is available in the `enn-sdk-samples/depth-estimation` directory within the [Github](https://github.com/exynos-eco/enn-sdk-samples) repository.
...
#### Location
The sample is available in the `enn-sdk-samples/gaze-estimation` directory within the [Github](https://github.com/exynos-eco/enn-sdk-samples) repository.
...
In addition, the predicted class label and the inference time are displayed on the application interface.

#### Location
The sample is available in the `enn-sdk-samples/video-classification` directory within the [Github](https://github.com/exynos-eco/enn-sdk-samples) repository.
