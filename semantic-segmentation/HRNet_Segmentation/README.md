...
This document describes a method to operate Android sample application operates using the [HRNet_Segmentation](https://soc-developer.semiconductor.samsung.com/global/solution/ai/models/detail/HrNet_Segmentation) model that is optimized for Exynos hardware.
...
<p align="center" width="100%">
  <img src="HRNet_Segmentation.png" alt="App Classification UI" height="400"/>
</p>
